...
class BannerDetailsResponse {
  ...
  BannerDetailsResponse({this.success, this.isAuth, this.message, this.result});

  BannerDetailsResponse.fromJson(Map<String, dynamic> json) {
...
//   String? primaryColor;
//   String? profileBannerImageURL;
//   List<Null>? colorFilter;
//
//   CustomImageCardDesignInfo(
//       {this.primaryColor, this.profileBannerImageURL, this.colorFilter});
//
//   CustomImageCardDesignInfo.fromJson(Map<String, dynamic> json) {
//     primaryColor = json['primaryColor'];
//     profileBannerImageURL = json['profileBannerImageURL'];
//     if (json['colorFilter'] != null) {
//       colorFilter = <Null>[];
//       json['colorFilter'].forEach((v) {
//         colorFilter!.add(new Null.fromJson(v));
//       });
//     }
//   }
//
...
//       data['colorFilter'] = this.colorFilter!.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
// }
